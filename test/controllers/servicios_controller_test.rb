...
class ServiciosControllerTest < ActionController::TestCase
  ...
  test "should create servicio" do
    assert_difference('Servicio.count') do
      post :create, servicio: { autorizado: @servicio.autorizado, descripcion: @servicio.descripcion, entidad: @servicio.entidad, fregistro: @servicio.fregistro, informante: @servicio.informante, infraestructura: @servicio.infraestructura, mercado: @servicio.mercado, nombre: @servicio.nombre, resultados: @servicio.resultados, tipo: @servicio.tipo }
    end
  ...
  test "should update servicio" do
    patch :update, id: @servicio, servicio: { autorizado: @servicio.autorizado, descripcion: @servicio.descripcion, entidad: @servicio.entidad, fregistro: @servicio.fregistro, informante: @servicio.informante, infraestructura: @servicio.infraestructura, mercado: @servicio.mercado, nombre: @servicio.nombre, resultados: @servicio.resultados, tipo: @servicio.tipo }
    assert_redirected_to servicio_path(assigns(:servicio))
  end
