...
class CatalogosControllerTest < ActionController::TestCase
  ...
  test "should create catalogo" do
    assert_difference('Catalogo.count') do
      post :create, catalogo: { autorizado: @catalogo.autorizado, descripcion: @catalogo.descripcion, entidad: @catalogo.entidad, fregistro: @catalogo.fregistro, informante: @catalogo.informante, infraestructura: @catalogo.infraestructura, mercado: @catalogo.mercado, nombre: @catalogo.nombre, resultados: @catalogo.resultados, tipo: @catalogo.tipo }
    end
  ...
  test "should update catalogo" do
    patch :update, id: @catalogo, catalogo: { autorizado: @catalogo.autorizado, descripcion: @catalogo.descripcion, entidad: @catalogo.entidad, fregistro: @catalogo.fregistro, informante: @catalogo.informante, infraestructura: @catalogo.infraestructura, mercado: @catalogo.mercado, nombre: @catalogo.nombre, resultados: @catalogo.resultados, tipo: @catalogo.tipo }
    assert_redirected_to catalogo_path(assigns(:catalogo))
  end
