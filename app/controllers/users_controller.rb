class UsersController < ApplicationController
  ...
  def destroy
    @user.destroy
    respond_to do |format|
      format.html { redirect_to users_url, notice: 'El usuario se ha eliminado satisfactoriamente. ' }
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:siglas, :email, :password, :password_confirmation, :fingreso, :tipo)
    end
end
